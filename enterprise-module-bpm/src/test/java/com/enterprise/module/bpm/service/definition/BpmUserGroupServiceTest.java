...
import com.enterprise.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import com.enterprise.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import com.enterprise.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.enterprise.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.enterprise.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("企业管理平台")));
       // 测试 status 不匹配
