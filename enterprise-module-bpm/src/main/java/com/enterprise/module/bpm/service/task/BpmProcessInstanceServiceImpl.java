package com.enterprise.module.bpm.service.task;
...
import com.enterprise.framework.common.util.object.ObjectUtils;
import com.enterprise.framework.common.util.object.PageUtils;
import com.enterprise.framework.datapermission.core.annotation.DataPermission;
import com.enterprise.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.enterprise.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.enterprise.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.enterprise.module.bpm.controller.admin.task.vo.instance.*;
import com.enterprise.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.enterprise.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.enterprise.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.enterprise.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.enterprise.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.enterprise.module.bpm.enums.ErrorCodeConstants;
import com.enterprise.module.bpm.enums.definition.BpmModelTypeEnum;
import com.enterprise.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.enterprise.module.bpm.enums.task.BpmAttachmentTypeEnum;
import com.enterprise.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.enterprise.module.bpm.enums.task.BpmReasonEnum;
import com.enterprise.module.bpm.enums.task.BpmTaskStatusEnum;
import com.enterprise.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.enterprise.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.enterprise.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.enterprise.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.enterprise.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.enterprise.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.enterprise.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.enterprise.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.enterprise.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.enterprise.module.bpm.service.definition.BpmProcessDefinitionService;
import com.enterprise.module.bpm.service.message.BpmMessageService;
import com.enterprise.module.system.api.dept.DeptApi;
import com.enterprise.module.system.api.dept.dto.DeptRespDTO;
...
import static com.enterprise.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.enterprise.module.bpm.enums.ErrorCodeConstants.*;
import static com.enterprise.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.enterprise.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
