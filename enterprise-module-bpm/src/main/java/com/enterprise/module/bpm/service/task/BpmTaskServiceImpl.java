...
import com.enterprise.module.bpm.controller.admin.task.vo.task.*;
import com.enterprise.module.bpm.convert.task.BpmTaskConvert;
import com.enterprise.module.bpm.dal.dataobject.definition.BpmFormDO;
import com.enterprise.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.enterprise.module.bpm.enums.definition.*;
import com.enterprise.module.bpm.enums.task.*;
...
import com.enterprise.module.bpm.service.definition.BpmFormService;
import com.enterprise.module.bpm.service.definition.BpmModelService;
...
import com.enterprise.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static com.enterprise.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void returnTask(Long userId, BpmnModel bpmnModel, Task currentTask, FlowElement targetElement, BpmTaskReturnReqVO reqVO) {
        ...
        // ⑤ 使用 moveExecutionsToSingleActivityId 方法进行回退操作时，如果是多实例的用户任务【企业管理平台用户任务默认为多实例】，不会删除多实例任务的根数据 ACT_RU_EXECUTION
