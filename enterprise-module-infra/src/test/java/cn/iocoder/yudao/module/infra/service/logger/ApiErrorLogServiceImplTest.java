package com.enterprise.module.infra.service.logger;
...
import com.enterprise.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.enterprise.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.enterprise.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.enterprise.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.enterprise.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.enterprise.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.enterprise.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("enterprise-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("enterprise-test");
