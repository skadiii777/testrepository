package com.enterprise.module.infra.service.file;
...
import com.enterprise.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.enterprise.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.enterprise.module.infra.dal.dataobject.file.FileConfigDO;
import com.enterprise.module.infra.dal.mysql.file.FileConfigMapper;
import com.enterprise.module.infra.framework.file.core.client.FileClient;
import com.enterprise.module.infra.framework.file.core.client.FileClientConfig;
import com.enterprise.module.infra.framework.file.core.client.FileClientFactory;
import com.enterprise.module.infra.framework.file.core.client.local.LocalFileClient;
import com.enterprise.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.enterprise.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.enterprise.framework.test.core.util.RandomUtils.randomLongId;
import static com.enterprise.framework.test.core.util.RandomUtils.randomPojo;
import static com.enterprise.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.enterprise.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("企业管理平台源码")
