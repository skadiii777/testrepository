package com.enterprise.module.infra.websocket;
...
import com.enterprise.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.enterprise.module.infra.websocket.message.DemoReceiveMessage;
import com.enterprise.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 enterprise.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
