package com.enterprise.module.infra.controller.admin.logger.vo.apiaccesslog;
...
import com.enterprise.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @Schema(description = "结果提示", example = "企业管理平台源码，牛逼！")
    @ExcelProperty("结果提示")
