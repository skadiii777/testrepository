package com.enterprise.module.system.service.tenant;

import com.enterprise.framework.common.enums.CommonStatusEnum;
import com.enterprise.framework.common.pojo.PageResult;
import com.enterprise.framework.tenant.config.TenantProperties;
...
import com.enterprise.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.enterprise.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.enterprise.module.system.dal.dataobject.permission.MenuDO;
...
import com.enterprise.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.enterprise.module.system.dal.mysql.tenant.TenantMapper;
import com.enterprise.module.system.enums.permission.RoleCodeEnum;
import com.enterprise.module.system.enums.permission.RoleTypeEnum;
import com.enterprise.module.system.service.permission.MenuService;
...
import com.enterprise.module.system.service.tenant.handler.TenantInfoHandler;
import com.enterprise.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.enterprise.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("企业管理平台", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("企业管理平台"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("企业管理平台");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
