package com.enterprise.module.system.service.mail;
...
import com.enterprise.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.enterprise.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import com.enterprise.module.system.dal.dataobject.mail.MailTemplateDO;
import com.enterprise.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.enterprise.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("企业管理平台")));
        // 测试 code 不匹配
