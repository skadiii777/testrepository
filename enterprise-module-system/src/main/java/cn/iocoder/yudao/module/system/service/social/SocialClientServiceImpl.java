package com.enterprise.module.system.service.social;
...
import com.enterprise.framework.common.util.cache.CacheUtils;
import com.enterprise.framework.common.util.http.HttpUtils;
import com.enterprise.framework.common.util.object.BeanUtils;
import com.enterprise.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.enterprise.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.enterprise.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.enterprise.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.enterprise.module.system.controller.admin.social.vo.client.SocialClientPageReqVO;
import com.enterprise.module.system.controller.admin.social.vo.client.SocialClientSaveReqVO;
import com.enterprise.module.system.dal.dataobject.social.SocialClientDO;
import com.enterprise.module.system.dal.mysql.social.SocialClientMapper;
import com.enterprise.module.system.dal.redis.RedisKeyConstants;
import com.enterprise.module.system.enums.social.SocialTypeEnum;
import com.enterprise.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.enterprise.framework.common.util.collection.MapUtils.findAndThen;
import static com.enterprise.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.enterprise.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.enterprise.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${enterprise.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${enterprise.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/enterprise-cloud/pulls/230
