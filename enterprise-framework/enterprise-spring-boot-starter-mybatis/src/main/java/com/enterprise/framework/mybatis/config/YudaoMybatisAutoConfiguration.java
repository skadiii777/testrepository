package com.enterprise.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.enterprise.framework.common.util.json.JsonUtils;
import com.enterprise.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${enterprise.info.base-package}", annotationClass = Mapper.class,
