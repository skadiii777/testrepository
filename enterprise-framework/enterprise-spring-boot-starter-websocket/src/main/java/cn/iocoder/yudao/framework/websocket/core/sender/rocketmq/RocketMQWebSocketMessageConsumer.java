package com.enterprise.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${enterprise.websocket.sender-rocketmq.topic}",
        consumerGroup = "${enterprise.websocket.sender-rocketmq.consumer-group}",
