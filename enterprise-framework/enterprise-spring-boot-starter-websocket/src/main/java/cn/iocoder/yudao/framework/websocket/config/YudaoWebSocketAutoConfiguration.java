package com.enterprise.framework.websocket.config;

import com.enterprise.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import com.enterprise.framework.mq.redis.core.RedisMQTemplate;
import com.enterprise.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.enterprise.framework.websocket.core.listener.WebSocketMessageListener;
import com.enterprise.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.enterprise.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.enterprise.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.enterprise.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.enterprise.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.enterprise.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.enterprise.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.enterprise.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.enterprise.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.enterprise.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.enterprise.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.enterprise.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.enterprise.framework.websocket.core.session.WebSocketSessionManager;
import com.enterprise.framework.websocket.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "enterprise.websocket", value = "enable", matchIfMissing = true) // 允许使用 enterprise.websocket.enable=false 禁用 websocket
...
public class YudaoWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "enterprise.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "enterprise.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "enterprise.websocket", name = "sender-type", havingValue = "rocketmq")
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${enterprise.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "enterprise.websocket", name = "sender-type", havingValue = "rabbitmq")
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${enterprise.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "enterprise.websocket", name = "sender-type", havingValue = "kafka")
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${enterprise.websocket.sender-kafka.topic}") String topic) {
