package com.enterprise.framework.desensitize.core;

import com.enterprise.framework.common.util.json.JsonUtils;
import com.enterprise.framework.desensitize.core.annotation.Address;
import com.enterprise.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.enterprise.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.enterprise.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("企业管理平台源码");
        ...
        desensitizeDemo.setRegex("你好，我是企业管理平台源码");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("企业管理平台源码");
        ...
        assertEquals("企业管理平台源码", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "企业管理平台源码", replacer = "*")
