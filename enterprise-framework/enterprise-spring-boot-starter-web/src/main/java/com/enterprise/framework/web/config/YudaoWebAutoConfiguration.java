package com.enterprise.framework.web.config;
...
import com.enterprise.framework.web.core.filter.CacheRequestBodyFilter;
import com.enterprise.framework.web.core.filter.DemoFilter;
import com.enterprise.framework.web.core.handler.GlobalExceptionHandler;
import com.enterprise.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YudaoWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "enterprise.demo", havingValue = "true")
