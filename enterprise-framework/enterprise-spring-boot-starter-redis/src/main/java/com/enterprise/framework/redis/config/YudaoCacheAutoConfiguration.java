package com.enterprise.framework.redis.config;

import cn.hutool.core.util.StrUtil;
import com.enterprise.framework.redis.core.TimeoutRedisCacheManager;
...
import static com.enterprise.framework.redis.config.YudaoRedisAutoConfiguration.buildRedisSerializer;
...
public class YudaoCacheAutoConfiguration {
    ...
    public RedisCacheConfiguration redisCacheConfiguration(CacheProperties cacheProperties) {
        ...
        // 再次修复单冒号，而不是双 :: 冒号问题，Issues 详情：https://gitee.com/zhijiantianya/enterprise-cloud/issues/I86VY2
