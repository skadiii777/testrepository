 ...
 *      1）Spring Async：
 *          {@link com.enterprise.framework.quartz.config.YudaoAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 ...
 *
 */
package com.enterprise.framework.tenant;
