...
export enum DICT_TYPE {
  ...
  // ========== 企业业务模块 ==========
  BIZ_COMMON_STATUS = 'biz_common_status',
  BIZ_CONTRACT_STATUS = 'biz_contract_status',
  BIZ_INOUT_STATUS = 'biz_inout_status',
  BIZ_ATTENDANCE_STATUS = 'biz_attendance_status',
  BIZ_LEAVE_TYPE = 'biz_leave_type',
  BIZ_LEAVE_STATUS = 'biz_leave_status',
  BIZ_REPORT_TYPE = 'biz_report_type',
  BIZ_EXPENSE_TYPE = 'biz_expense_type',
  BIZ_EXPENSE_STATUS = 'biz_expense_status',
  BIZ_STOCK_MOVE_TYPE = 'biz_stock_move_type',
  BIZ_CORRECTION_TYPE = 'biz_correction_type',
  BIZ_CORRECTION_STATUS = 'biz_correction_status',
  BIZ_PAYMENT_TYPE = 'biz_payment_type',
  BIZ_PAYMENT_METHOD = 'biz_payment_method',
  BIZ_CHECK_STATUS = 'biz_check_status',
  BIZ_RETURN_TYPE = 'biz_return_type',
  BIZ_RETURN_STATUS = 'biz_return_status',
  BIZ_CLUE_SOURCE = 'biz_clue_source',
  BIZ_CLUE_STATUS = 'biz_clue_status',
  BIZ_BUSINESS_STAGE = 'biz_business_stage',
  BIZ_ANNOUNCEMENT_TYPE = 'biz_announcement_type',
  BIZ_FMS_ACCOUNT_TYPE = 'biz_fms_account_type',
  BIZ_FMS_DIRECTION = 'biz_fms_direction',
  BIZ_FMS_VOUCHER_STATUS = 'biz_fms_voucher_status',
  BIZ_WMS_LOCATION_TYPE = 'biz_wms_location_type',
  BIZ_WMS_MOVE_TYPE = 'biz_wms_move_type'
}
